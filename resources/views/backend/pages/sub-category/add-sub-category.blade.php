            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Add Sub Category
                                <a href="{{route('sub-category')}}" class="btn-sm btn-success"><i class="fa fa-eye"></i></a>
                            </h2>
                            ...
                            <div class="col-md-12">
                                ...
                                <form action="{{route('add-sub-category')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sub_cat_name" class="form-control form-control-sm" id="title" value="{{old('sub_cat_name')}}">
                                    </div>
                                    <div class="form-group">
